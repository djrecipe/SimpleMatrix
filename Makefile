...
display-test: display-test.o Bitmap.o BitmapSet.o BitmapManager.o GridTransformer.o Microphone.o FFT.o mailbox.o gpu_fft.o gpu_fft_base.o gpu_fft_shaders.o gpu_fft_twiddles.o Config.o glcdfont.o ./rpi-rgb-led-matrix/lib/librgbmatrix.a
